...
class WordEncoder(nn.Module):
    def __init__(self, opts):
        ...
        self.lstm = nn.GRU(embed_size, hidden_size, batch_first=True, bidirectional=self.opts["bidirectional"])
...
class SentenceEncoder(nn.Module):
    def __init__(self, opts):
        ...
        self.opts = opts
        self.lstm = nn.GRU(hidden_size, hidden_size, bidirectional=self.opts["bidirectional"])
    ...
    def forward(self, words_encoder_outputs):
        ...
        sentence_outputs, s_hx = self.lstm(sequence)
